...
export default {
    ...
    source_url:
        'https://www.belastingdienst.nl/wps/wcm/connect/nl/belastingaangifte/content/belastingtarieven-box-1',
};
...
export function calculateNL(gross) {
    ...
    return {
        ...
        social_security_breakdown: [{ name: 'ZVW (Health)', amount: Math.round(zvw * 100) / 100 }],
        regional_tax: 0,
