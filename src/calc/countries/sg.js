...
export default {
    ...
    social_security: [
        { name: 'CPF (Employee)', rate: 0.2, cap: 102000 }, // Annual cap ~$6,800/month
    ],
...
export function calculateSG(gross) {
    ...
    const cpf = Math.min(gross, cpfCeiling) * 0.2;
    ...
    return {
        ...
        marginal_rate: marginalRate + (gross <= cpfCeiling ? 0.2 : 0),
        confidence: 'high',
        assumptions: [
            'Tax resident',
            'No dependents',
