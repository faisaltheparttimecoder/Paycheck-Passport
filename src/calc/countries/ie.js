...
export function calculateIE(gross) {
    ...
    if (gross <= standardRateCutoff) {
        ...
        incomeTax = standardRateCutoff * 0.2 + (gross - standardRateCutoff) * 0.4;
    }
    ...
    // Marginal rate
    let marginalRate = gross > standardRateCutoff ? 0.4 : 0.2;
    // Add USC marginal
    ...
    return {
        ...
        confidence: 'high',
        assumptions: ['Single filer', 'No dependents', 'PAYE employee', 'Tax credits applied'],
    };
}
