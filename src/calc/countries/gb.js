...
export default {
    ...
    income_tax: {
        ...
        brackets: [
            ...
            { up_to: 50270, rate: 0.2 }, // Basic rate
            { up_to: 125140, rate: 0.4 }, // Higher rate
...
export function calculateUK(gross) {
    ...
    let incomeTax = 0;
    const brackets = [
        { up_to: 37700, rate: 0.2 }, // Basic rate (on taxable income)
        { up_to: 87440, rate: 0.4 }, // Higher rate (125140 - 37700)
        { up_to: null, rate: 0.45 }, // Additional rate
    ];
    ...
    let marginalRate = 0;
    if (taxableIncome <= 37700) marginalRate = 0.2;
    else if (taxableIncome <= 87440) marginalRate = 0.4;
