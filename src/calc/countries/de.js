...
export function calculateDE(gross) {
  ...
  else if (gross <= 17005) marginalRate = 0.14 + ((gross - 11604) / (17005 - 11604)) * (0.24 - 0.14);
  else if (gross <= 66760) marginalRate = 0.24 + ((gross - 17005) / (66760 - 17005)) * (0.42 - 0.24);
  else if (gross <= 277825) marginalRate = 0.42;
  else marginalRate = 0.45;
  
  // Add social security marginal (roughly 20% up to caps)
  if (gross <= 62100) marginalRate += 0.202;  // All contributions apply
